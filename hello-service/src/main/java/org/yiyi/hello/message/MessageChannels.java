...
{
    public static final String HELLO_CHANNEL = "helloChannel";
    public static final String HELLO_CALLBACK_CHANNEL = "helloCallbackChannel";

    @Input (MessageChannels.HELLO_CHANNEL)
    MessageChannel helloInput ();

    @Output (MessageChannels.HELLO_CALLBACK_CHANNEL)
    MessageChannel helloBackOutput ();
}
